...
## Environments
- Preview: https://main--swetabar-roche--aemysites.aem.page/
- Live: https://main--swetabar-roche--aemysites.aem.live/
- Block Library: https://main--swetabar-roche--aemysites.aem.page/tools/sidekick/library.html?plugin=blocks
...
1. Open the `swetabar-roche` directory in your favorite IDE and start coding :)
